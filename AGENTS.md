...
## Next-Move-Theory (NMT)
Это внешний репозиторий с документацией на методологию с которой я работаю. Она полностью на английском языке. При работе с методологией, ее скиллами и прочее, что с ней связано: всегда возращай на русскомя языке, даже если в самой методологии указан английский. Это приоритетное требование по работе с NMT.
